...
public class SameRowTwoPairStepTest {

    @Autowired
    private SameRowTwoPairStep sameRowTwoPairStep;

    @ParameterizedTest
    @MethodSource("differentBoards")
    public void testDifferentBoards(String testId, Board board, int emptyCells, Map<Corner.Cell, CellValue> cellValueMap) {

        sameRowTwoPairStep.execute(board);
    ...
    private static Stream<Arguments> differentBoards() {
        return Stream.of(
                 ...
                 */
                Arguments.of(
                        "direction: right, bottom-left and bottom-right",
                 ...
                 */
                Arguments.of(
                        "direction: right, top-left and top-right",
                        getBoard(4, 4, List.of(
                                        new Corner(1, 1, 2),
                                        new Corner(1, 2, 2),
                                        new Corner(1, 3, 2)
                 ...
                 */
                Arguments.of(
                        "direction: bottom, top-left and bottom-left",
                        getBoard(4, 4, List.of(
                                        new Corner(1, 1, 2),
                                        new Corner(2, 1, 2)
                                ),
                 ...
                 */
                Arguments.of(
                        "direction: bottom, top-right and bottom-right",
                        getBoard(4, 4, List.of(
                                        new Corner(1, 1, 2),
                                        new Corner(2, 1, 2),
                                        new Corner(3, 1, 2)
